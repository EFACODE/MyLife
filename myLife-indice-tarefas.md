...
| **T3.2** | 📝 | Manual event capture API | Yes | Users record Life Events by hand → `LifeEventRecorded`. Proves the loop with zero connectors. `specs/domain/timeline/manual-capture.md` — **in review, awaiting approval.** |
