...
| **T3.5** | 📝 | First connector (Calendar / ICS-CSV import) | Yes | One concrete connector proving the framework end-to-end into the timeline. `specs/domain/timeline/calendar-connector.md` — **in review, awaiting approval.** |
