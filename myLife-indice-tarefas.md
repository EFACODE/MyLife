...
| **T1.3** | 📝 | Event bus (Redis) + in-process dispatcher | Yes | Publish `LifeEventRecorded`; subscribers drive projections. Redis broker from `T0.2`/`T0.9`. `specs/domain/timeline/event-bus.md` — **in review, awaiting approval.** |
